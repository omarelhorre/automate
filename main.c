...
int menu(void){
        ...
        printf("5. Afficher les etats avec transition etiquete a partir d'une lettre entré par l'utilisateur .  \n6. Tester un mot si il appartient au langage engendre  \n7. extraire tous les mots accepter dans un fichier.\n");
